...
function FilmsIndexComponent() {
  ...
  return (
    <div className="px-5 pb-32 pt-32 md:px-10 md:pt-44">
      <Reveal>
      ...
      <ul className="mt-24 grid gap-x-8 gap-y-20 md:grid-cols-2">
        {films.map((film, i) => (
          <Reveal
            key={film.slug}
            as="li"
          ...
          >
            ...
            >
              ...
              <p className="mt-2 max-w-md text-sm text-taupe">{film.logline}</p>
            </button>
          </Reveal>
        ))}
      </ul>
